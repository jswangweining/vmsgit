...
<div v-loading.body='loadingall' class="bodyscroll">
    ...
    <div class="w-con2flex">
            ...
            <wform :inline="true" :model="formdata" label-position="right" class="demo-form-inline">
                <div class="">
                    <form-item label="时间区间：" class="radio0Month">
                        <date-picker type="month" v-model="formdata.startmonth" :placeholder="monthPlaceHolder" :editable='false' :picker-options="pickerOptions" style="width:250px;" @change='monthchange1'>
                        </date-picker>
                        <span class="w-searchs">至</span>
                        <date-picker type="month" v-model="formdata.endmonth" :placeholder="monthPlaceHolder" :editable='false' :picker-options="pickerOptions" style="width:250px;" @change='monthchange2'>
                        </date-picker>
                    </form-item>
                </div>
        ...
        <div class="w-pannel" style="flex:1; margin-bottom:10px;">
            <div class="w-pannelitem">
                ...
                <div class="w-pannelitema" style="margin-left:15px;">
                    ...
                    <div class="w-pannelitemad">
                        <div class="" id="mainyhfx2" style="width:70%; height:200px; float:left">

                        </div>
                        <div class="w-pannelitemadF">
                          <div class="w-pannelitemadFa" v-for='(item,index) in jsondata.map'>
                            金额：{{item.value}}
                          </div>
